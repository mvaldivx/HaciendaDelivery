...
export function customAlertoutAnimation(AnimationC: Animation, baseEl: HTMLElement): Promise<Animation>{
...
export function customAlertinAnimation(AnimationC: Animation, baseEl: HTMLElement): Promise<Animation>{
    const baseAnimation = new AnimationC();
    const backdropAnimation = new AnimationC();
    backdropAnimation.addElement(baseEl.querySelector('ion-backdrop'));
    const wrapperAnimation = new AnimationC();
